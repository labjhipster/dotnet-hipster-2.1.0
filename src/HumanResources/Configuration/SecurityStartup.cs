using System;
using HumanResources.Infrastructure.Configuration;
using System.IdentityModel.Tokens.Jwt;
using System.Text;
using HumanResources.Infrastructure.Data;
using HumanResources.Domain;
using HumanResources.Security;
using HumanResources.Security.Jwt;
using HumanResources.Domain.Services;
using HumanResources.Domain.Services.Interfaces;
...
using AuthenticationService = HumanResources.Domain.Services.AuthenticationService;
using IAuthenticationService = HumanResources.Domain.Services.Interfaces.IAuthenticationService;

namespace HumanResources.Configuration
{
