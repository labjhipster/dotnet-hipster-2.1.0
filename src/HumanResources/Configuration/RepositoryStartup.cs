...
using HumanResources.Infrastructure.Data.Repositories;
        ...
        public static IServiceCollection AddRepositoryModule(this IServiceCollection services)
        {
            ...
            services.Scan(scan => scan
                .FromAssembliesOf(typeof(IUnitOfWork), typeof(UnitOfWork))
                    ...
                    .AddClasses(classes => classes.InNamespaces("HumanResources.Infrastructure.Data.Repositories"))
                    ...
                    .AddClasses(classes => classes.Where(type => type.Namespace.Equals("HumanResources.Infrastructure.Data.Repositories") &&
