...
using HumanResources.Configuration.AutoMapper;
using HumanResources.Test.Setup;
using Microsoft.EntityFrameworkCore;
using Newtonsoft.Json.Linq;
using Xunit;

namespace HumanResources.Test.Controllers
{
    public class JobResourceIntTest
    {
        ...
        public async Task UpdateNonExistingJob()
        {
            ...
            JobDto _jobDto = _mapper.Map<JobDto>(_job);
            var response = await _client.PutAsync("/api/jobs", TestUtil.ToJsonContent(_jobDto));
